        ...
        <table align="center" class="FullHeight StandardWidth" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" height="100%" cellpadding="0" cellspacing="0">
								<tr>
            <td class="PanelTD PanelWidth"><DIV class="PanelWidth PanelMid PanelBG"><DIV class="PanelGrad"><DIV class="PanelBL"><DIV class="PanelBR"><DIV class="PanelTL"><DIV class="PanelTR">
							<IMG src="<%=skinpath%>dummy.gif" height="1" width="194" class="Dotted"><BR /><dnn:SOLPARTMENU
								...
								/><IMG src="<%=skinpath%>dummy.gif" height="1" width="194"><BR />
