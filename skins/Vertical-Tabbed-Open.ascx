  ...
  <tr>
    <td align="center" valign="top" class="OuterTable">
        <table align="center" class="FullHeight StandardWidth" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="ImagePane01V" colspan="2" valign="top" id="ImagePane01" runat="server" visible="false"></td>
          </tr>
          <tr>
            <td class="ImagePane02V" colspan="2" valign="top" id="ImagePane02" runat="server" visible="false"></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<table width="100%" height="100%" cellpadding="0" cellspacing="0">
								<tr>
            <td class="PanelTD PanelWidth" valign="top"><DIV class="PanelWidth PanelMid PanelBG"><DIV class="PanelGrad"><DIV class="PanelBL"><DIV class="PanelBR"><DIV class="PanelTL"><DIV class="PanelTR">
							<dnn:SOLPARTMENU
								runat="server"
								id="dnnSOLPARTMENU"
								menualignment="left"
								...
								/><IMG src="<%=skinpath%>dummy.gif" height="1" width="202"><BR />
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td class="PanelPane" valign="top" id="PanelPane" runat="server" visible="false"></td>
								</tr>
							</table>
          ...
          <tr>
            <td class="CopyrightRow" colspan="2">
				...
				<table width="100%" cellpadding="0" cellspacing="0"><TR>
					...
					<span class="FOOTER_objects"><IMG src="<%=skinpath%>nav4-over.gif" height="1" width="1" class="Invisible"><IMG src="<%=skinpath%>dummy.gif" height="1" width="1" class="Invisible"><IMG src="<%=skinpath%>dummy.gif" height="1" width="1" class="Invisible"><IMG src="<%=skinpath%>ico-login-over.gif" height="1" width="1" class="Invisible"><IMG src="<%=skinpath%>ico-register-over.gif" height="1" width="1" class="Invisible"><BR><dnn:COPYRIGHT runat="server" id="dnnCOPYRIGHT" CssClass="FOOTER_objects" /></span>
					</TD>
				</TR></TABLE>
